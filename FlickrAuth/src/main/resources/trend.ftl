...
<html lang="en">
<head>
    <title>Epsilon >> Trend Aggregator</title>
...
<div id="wrapper" class="container_12 clearfix">
    ...
    <!-- Text Logo -->
    <h1 id="logo" class="grid_6">Trend Aggregator</h1>

    <!-- Navigation Menu -->
    <ul id="navigation" class="grid_6">
        <li><a href="trend.ftl" class="current"><span class="meta">Our Project</span><br />Latest Trends</a></li>
        <li><a href="about.ftl"><span class="meta">Who are we?</span><br />About Us</a></li>
    </ul>

    <div class="hr grid_12 clearfix">&nbsp;</div>

    <!-- Catch Line and Link -->
    <h2 class="grid_12 caption clearfix">The <span>Social Trends</span>, home to our latest, and greatest project.</h2>
    ...
    <div class="catagory_1 clearfix">
        ...
        <div class="grid_3 textright" >
            <span class="meta">What is the project?</span>
            <h4 class="title ">Trend Aggregator</h4>
            <div class="hr clearfix dotted">&nbsp;</div>
            <p align="justify">Trends application aggregates trending topics from Twitter and popular media from Instagram.</p>
        </div>
        <div class="grid_6">
            <h2 class="title">Trending Images on Instagram </h2>
            <div class="hr clearfix dotted">&nbsp;</div>
        <#list instaUrls as url>
            <img src="${url}" alt="" style="width:400px; height:400px; margin-bottom: 10px"/>
        </#list>

        </div>
        <div class="grid_3 right">
            <h2 class="title ">Trending Topics on Twitter</h2>
            <div class="hr clearfix dotted">&nbsp;</div>
            <ul>
            <#list twitNames as name>
                <li>
                    <a <#list twitUrls as url>href="${url}"</#list>>${name}</a>
    ...
    <p class="grid_12 footer clearfix">
        <span class="float"><b>&copy; Copyright</b> <a href="">Team Epsilon</a></span>
